...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th10 26, 2023 lúc 05:37 PM
...
(4, 'Dưa hấu', 1, 2, 5, '2023-10-23 08:35:56'),
(5, 'Hành lá', 1, 3, 100, '2023-10-25 15:52:22'),
(6, 'Cá cam', 2, 2, 5, '2023-10-26 14:26:49');
...
(16, 2, 1, 5, 22000, '2023-10-25 15:06:58'),
(17, 5, 3, 500, 20, '2023-10-25 15:53:12'),
(18, 4, 2, 20, 5000, '2023-10-25 15:53:27'),
(19, 2, 3, 12, 25000, '2023-10-25 15:53:46'),
(20, 6, 3, 15, 40000, '2023-10-26 14:38:57'),
(23, 1, 3, 20, 47000, '2023-10-26 15:14:44'),
(24, 3, 1, 1000, 120, '2023-10-26 16:06:45');

--
-- Bẫy `ingredient_detail`
--
DELIMITER $$
CREATE TRIGGER `after_ingredient_detail_delete` AFTER DELETE ON `ingredient_detail` FOR EACH ROW BEGIN
    DELETE FROM `stock` WHERE `ingredientDetailId` = OLD.`id`;
END
$$
DELIMITER ;
DELIMITER $$
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `after_ingredient_detail_update` AFTER UPDATE ON `ingredient_detail` FOR EACH ROW BEGIN
    UPDATE
        `stock`
    SET
        `importQuantity` = NEW.quantity,
        `exportQuantity` = 0,
        `createdDate` = NOW()
    WHERE
        `ingredientDetailId` = OLD.`id` ;
        END
$$
DELIMITER ;
...
(8, 16, 5, 0, '2023-10-26 15:11:40'),
(9, 17, 500, 0, '2023-10-26 15:11:37'),
(10, 18, 20, 0, '2023-10-26 15:11:34'),
(11, 19, 12, 0, '2023-10-26 15:11:23'),
(12, 20, 15, 0, '2023-10-26 15:11:20'),
(15, 23, 20, 0, '2023-10-26 15:14:44'),
(16, 24, 1000, 0, '2023-10-26 16:06:45');
